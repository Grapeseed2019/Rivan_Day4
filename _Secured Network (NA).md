...
ifconfig ens256 10.71.1.6 netmask 255.255.255.0 up
~~~
...
conf t
 ...
 router ospf 1
  ...
  exit
 ip name-server 10.71.1.10   !8.8.8.8 8.8.4.4
 ip domain lookup
...
Review: Create a DNS A record for www.ccna71.com
